...
export class Dolx__getListingResultValue0Struct extends ethereum.Tuple {
  get price(): BigInt {
...
export class Dolx extends ethereum.SmartContract {
  static bind(address: Address): Dolx {
    return new Dolx("Dolx", address);
  }

  getListing(
    nftAddress: Address,
    tokenId: BigInt
  ): Dolx__getListingResultValue0Struct {
    ...
    return changetype<Dolx__getListingResultValue0Struct>(result[0].toTuple());
  }

  try_getListing(
    nftAddress: Address,
    tokenId: BigInt
  ): ethereum.CallResult<Dolx__getListingResultValue0Struct> {
    ...
    return ethereum.CallResult.fromValue(
      changetype<Dolx__getListingResultValue0Struct>(value[0].toTuple())
    );
  }
